...
export default class App extends Component {
  ...
  getFilteredData(id) {
    ...
    axios
      .get(`http://ec2-18-191-56-236.us-east-2.compute.amazonaws.com:3001/reviews/searchQuery/${id}`, { params: { query: reviewSearch }, headers:{'Access-Control-Allow-Origin': '*', 'Content-Type': 'application/json'}}, )
      .then((data) => {
        this.setState(
          {
  ...
  getData(id) {
    axios.get(`http://ec2-18-191-56-236.us-east-2.compute.amazonaws.com:3001/reviews/${id}`,{
      headers: {
  ...
  getRatings(id){
    axios.get(`http://ec2-18-191-56-236.us-east-2.compute.amazonaws.com:3001/reviews/rating/${id}`,{
      headers: {
        'Access-Control-Allow-Origin': '*',
        'Content-Type': 'application/json'
      }
